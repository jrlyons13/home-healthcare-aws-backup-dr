"""Phase 6 team deck — through AWS Config HIPAA conformance pack (Phase 5 deck stays in phase5-team-review/)."""
...
OUTPUT = Path(__file__).parent / "Home-Healthcare-AWS-Backup-DR-Phase6-Team-Deck.pptx"
FOOTER_LEFT = "HOME HEALTHCARE AWS BACKUP/DR • PHASE 6 TEAM REVIEW"
...
SLIDES: list[dict] = [
    {
        ...
        "notes": "Open with synthetic-data disclaimer. Goal: show phases 0-6 including AWS Config.",
    },
    {
        "layout": "cards",
        "title": "Agenda",
        ...
        "cards": [
            ...
            {"label": "ARCHITECTURE", "body": "Walk phases 1-6: backup/DR through AWS Config HIPAA conformance pack.", "accent": "teal"},
            {"label": "LIVE DEMO", "body": "GitHub + AWS Config console + phase6-validate.ps1 (CONFIG_PHASE6=PASS).", "accent": "orange"},
        ],
    ...
    },
    {
        ...
        "bullets": [
            ...
            "Phases 0-6 complete | Phase 7 (RTO/RPO monitoring) optional next",
        ],
    ...
    },
    {
        ...
        "notes": "Phase 6 adds continuous config compliance (separate slide).",
    },
    {
        "layout": "bullets",
        ...
        "notes": "Config delivery bucket: home-healthcare-dr-config-376873818584.",
    },
    {
        "layout": "bullets",
        ...
        "bullets": [
            ...
            "terraform/environments/ — phase2 through phase6 stacks",
    ...
    },
    {
        ...
        "cards": [
            ...
            {"label": "RUN", "body": ".\\phase6-validate.ps1", "accent": "teal"},
            {"label": "EXPECT", "body": "CONFIG_PHASE6=PASS", "accent": "orange"},
        ],
        "notes": "Optional: phase5-e2e-simulation.ps1 still proves DR path.",
    },
    {
        "layout": "bullets",
        ...
        "bullets": [
            ...
            "CONFIG_PHASE6=PASS (HIPAA conformance pack operational)",
        ],
        "notes": "Confidence: backup, copy, restore, prove integrity, monitor config.",
    },
    {
        "layout": "cards",
        "title": "What's next",
        "subtitle": "Phase 7 and production hardening",
        "cards": [
            {"label": "PHASE 7", "body": "RTO/RPO alarms + custom Config rules for recovery point freshness.", "accent": "teal"},
            {"label": "PROD", "body": "MFA, Audit Manager, multi-account, org-wide Config.", "accent": "teal"},
            {"label": "PORTFOLIO", "body": "GitHub release tag; share Phase 5 or Phase 6 deck by audience.", "accent": "orange"},
        ],
        "notes": "Phase 5 team deck unchanged in phase5-team-review/.",
    },
    {
        "layout": "hero",
        "title": "Questions?",
